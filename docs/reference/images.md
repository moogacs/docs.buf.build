...
Images always include the ImageFileExtension field. However, if you want a pure
[`FileDescriptorSet`][filedescriptorset] without this field set, to mimic `protoc` entirely:
